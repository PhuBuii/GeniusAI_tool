...
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select' // Make sure to import these components
    ...
    <div>
      ...
      <div className='px-4 lg:px-8'>
        ...
        <div className='mt-4 space-y-4'>
          ...
          {images.length === 0 && !isLoading && <Empty label='No Images generated!!' type='image' />}
